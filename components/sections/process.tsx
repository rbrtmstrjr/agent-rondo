  ...
  return (
    <section id="process" className="relative scroll-mt-24 px-4 py-24 sm:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <RevealGroup className="relative mt-14 grid gap-4 md:grid-cols-3">
          {/* connecting line on desktop */}
          <div className="absolute left-0 top-12 hidden h-px w-full bg-gradient-to-r from-transparent via-line-strong to-transparent md:block" />
          {process.map((step) => (
