...
const NODES: Node[] = [
  { id: "trigger", x: 60, y: 180, label: "Trigger", sub: "form · email · chat" },
  { id: "ai", x: 220, y: 180, label: "AI Core", sub: "reason · decide", hub: true },
  { id: "crm", x: 388, y: 80, label: "CRM", sub: "logged" },
  { id: "notify", x: 388, y: 180, label: "Notify", sub: "Slack" },
  { id: "docs", x: 388, y: 280, label: "Database", sub: "Airtable" },
];
